 ...
 */
public class ListViewCreateInventoryAdapter extends BaseAdapter implements ListAdapter {
    private ArrayList<String> list = new ArrayList<String>();
    private Context context;

    public ListViewCreateInventoryAdapter(ArrayList<String> list, Context context) {
        this.list = list;
